...
func (c *pingerClient) PingStream(ctx context.Context, opts ...grpc.CallOption) (Pinger_PingStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Pinger_serviceDesc.Streams[0], c.cc, "/pinger.Pinger/PingStream", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("pingpb/ping.proto", fileDescriptorPing) }

var fileDescriptorPing = []byte{
	// 171 bytes of a gzipped FileDescriptorProto
	,
}
